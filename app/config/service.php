...
return array(
	...
	'pokedexalpha.orm.manager' => $application->share(function ($container) {
		$modelDirectory = __DIR__ . '/../../src/pokedexalpha/model';
		$proxyDirectory = __DIR__ . '/../../src/pokedexalpha/model/proxy';
		$proxyNamespace = 'PoKeDeXAlpha\Proxy';
	...
	'twig' => $application->share($application->extend('twig', function (Twig_Environment $twig, Application $application) {
		$loader = new Twig_Loader_Filesystem(__DIR__ . '/../../src/pokedexalpha/view');
